      ...
      <div>
        ...
        <div className='container'>
          ...
          {/*  <Switch> */}
              ...
              <Route exact path='/' render={routeProps => <QuoteHistory {...routeProps} setCurrentQuote={this.setCurrentQuote} currentQuote={this.state.currentQuote} userID={this.state.userID} />} /> 
